...
import com.bsoft.http.request.retrofit.download.DownLoadManager;
import com.bsoft.http.request.retrofit.upload.ExMultipartBody;
import com.bsoft.http.rxjava.Optional;
import com.bsoft.http.utils.FileUtil;
